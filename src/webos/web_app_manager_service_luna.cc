...
void WebAppManagerServiceLuna::DidConnect() {
  ...
  params["serviceName"] = std::string("com.webos.service.applicationManager");
...
void WebAppManagerServiceLuna::ApplicationManagerConnectCallback(
  ...
  if (reply["connected"] == true) {
    ...
    if (!Call<WebAppManagerServiceLuna,
            ...
            "luna://com.webos.service.applicationManager/listApps", params, this)) {
    ...
    if (!Call<WebAppManagerServiceLuna,
            ...
            "luna://com.webos.service.applicationManager/getForegroundAppInfo", params,
            this)) {
      LOG_WARNING(MSGID_APP_MGR_API_CALL_FAIL, 0,
...
void WebAppManagerServiceLuna::CloseApp(const std::string& id) {
  ...
  if (!LS2_CALL(CloseAppCallback, "luna://com.webos.service.applicationManager/close",
                json))
